...
from main import bcrypt_context, ALGORITHM, ACCESS_TOKEN_EXPIRE_MINUTES, ALGORITHM, SECRET_KEY
...
def autenticar_usuario(email: str, senha: str, session: Session = Depends(pegar_sessao)):
